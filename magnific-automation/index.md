...
- Bulk prompt queue for Magnific image and video workflows.
- Text to Image, Image to Image, Text to Video, Image to Video, and Frame Pair to Video modes.
- Live queue progress with queued, running, done, and failed states.
- Prompt-to-output matching for large batches.
- Optional auto-downloads with folder and filename controls.
