/*
  BB-8 (interactive / animation) — Grant Jenkins, January 2021
  https://www.khanacademy.org/profile/grantjenkins/projects
  Idea credited to Brad Colthurst: https://codepen.io/bullerb/pen/gMpxNZ

  Move the mouse to turn/move BB-8. Speed is set by the mouse distance.
  Click for three different color themes.

  Loaded as a classic script (not an ES module) on purpose: the Processing.js
  sketch idiom uses `with (processingInstance)`, which is a SyntaxError under
  the strict mode that every module in this app runs in.
*/
window.__bb8Sketch = function (processingInstance) {
  with (processingInstance) {
    ...
    var Scene = function() {
        ...
        this.themeColors = {
            orange: {
                hill: color(184, 174, 154)
            },
            red: {
                hill: color(145, 89, 87)
            },
            black: {
                hill: color(54, 51, 51)
            }
        ...
        this.init = function() {
            ...
            //add 25 spots on the ground
            for(var i = 0; i < 25; i++) {
                var y = random(420, 600);
                var w = map(y, 420, 600, 20, 100);
                this.spots.push({
                   x: random(width),
                   y: y,
                   w: w,
        ...
        this.setup = function() {
            this.images = {
                skyBlue: function() {
                    ...
                    noStroke();
                    for(var i = 0; i <= 400; i++) {
                        fill(lerpColor(color(54, 115, 150), color(76, 151, 191), i/400));
                        rect(0, i, width, 1);
                    }
                ...
                skyRed: function() {
                    ...
                    noStroke();
                    for(var i = 0; i <= 400; i++) {
                        fill(lerpColor(color(122, 67, 66), color(186, 116, 115), i/400));
                        rect(0, i, width, 1);
                    }
                ...
                skyBlack: function() {
                    ...
                    noStroke();
                    for(var i = 0; i <= 400; i++) {
                        fill(lerpColor(color(8, 8, 8), color(84, 87, 87), i/400));
                        rect(0, i, width, 1);
                    }
                ...
                ground: function() {
                    ...
                    noStroke();
                    for(var i = 0; i <= 200; i++) {
                        fill(lerpColor(color(225, 203, 156), color(243, 222, 179), i/200));
                        rect(0, i, width, 1);
                    }
